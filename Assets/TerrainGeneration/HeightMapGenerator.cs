...
namespace TerrainProceduralGenerator
{
    ...
    {
        public static HeightMap GeneratorHeightMap(int width, int height, HeightMapSettings settings,
            Vector2 sampleCenter)
        {
            float[,] values = Noise.GenerationNoiseMap(width, height, settings.noiseSettings, sampleCenter);
